-- PostgreSQL Production Seed Data
-- Uses ON CONFLICT DO NOTHING for safe re-seeding on every startup
...
-- Reset the sequences after inserting with explicit IDs
SELECT setval('states_id_seq', (SELECT COALESCE(MAX(id), 0) + 1 FROM states), false);
SELECT setval('constituencies_id_seq', (SELECT COALESCE(MAX(id), 0) + 1 FROM constituencies), false);
...
SELECT setval('polling_stations_id_seq', (SELECT COALESCE(MAX(id), 0) + 1 FROM polling_stations), false);
...
SELECT setval('parties_id_seq', (SELECT COALESCE(MAX(id), 0) + 1 FROM parties), false);
...
SELECT setval('voters_id_seq', (SELECT COALESCE(MAX(id), 0) + 1 FROM voters), false);

-- ============================================================
-- VOTES (4 per constituency = 100 total, spread across voters)
-- PostgreSQL uses space separator in timestamps (not T)
-- ============================================================
...
(1, 'VOTE-TN-001', '2026-05-06 08:30:00', 1, 1, 1, 1),
(2, 'VOTE-TN-002', '2026-05-06 08:45:00', 2, 1, 1, 1),
(3, 'VOTE-TN-003', '2026-05-06 09:00:00', 3, 2, 1, 1),
(4, 'VOTE-TN-004', '2026-05-06 09:15:00', 4, 1, 1, 2),
-- Chennai South votes (DMK wins 3-1)
(5, 'VOTE-TN-005', '2026-05-06 08:30:00', 7, 5, 2, 3),
(6, 'VOTE-TN-006', '2026-05-06 08:45:00', 8, 5, 2, 3),
(7, 'VOTE-TN-007', '2026-05-06 09:00:00', 9, 6, 2, 3),
(8, 'VOTE-TN-008', '2026-05-06 09:15:00', 10, 5, 2, 4),
-- Coimbatore North votes (DMK wins 3-1)
(9, 'VOTE-TN-009', '2026-05-06 09:30:00', 13, 9, 3, 5),
(10, 'VOTE-TN-010', '2026-05-06 09:45:00', 14, 9, 3, 5),
(11, 'VOTE-TN-011', '2026-05-06 10:00:00', 15, 10, 3, 5),
(12, 'VOTE-TN-012', '2026-05-06 10:15:00', 16, 9, 3, 6),
-- Madurai East votes (DMK wins 3-1)
(13, 'VOTE-TN-013', '2026-05-06 10:30:00', 19, 13, 4, 7),
(14, 'VOTE-TN-014', '2026-05-06 10:45:00', 20, 13, 4, 7),
(15, 'VOTE-TN-015', '2026-05-06 11:00:00', 21, 14, 4, 7),
(16, 'VOTE-TN-016', '2026-05-06 11:15:00', 22, 13, 4, 8),
-- Salem City votes (DMK wins 2-2, tie)
(17, 'VOTE-TN-017', '2026-05-06 11:30:00', 25, 17, 5, 9),
(18, 'VOTE-TN-018', '2026-05-06 11:45:00', 26, 18, 5, 9),
(19, 'VOTE-TN-019', '2026-05-06 12:00:00', 27, 17, 5, 9),
(20, 'VOTE-TN-020', '2026-05-06 12:15:00', 28, 18, 5, 10),
-- Thiruvananthapuram Central votes (CPIM wins 3-1)
(21, 'VOTE-KL-001', '2026-04-20 08:30:00', 31, 21, 6, 11),
(22, 'VOTE-KL-002', '2026-04-20 08:45:00', 32, 21, 6, 11),
(23, 'VOTE-KL-003', '2026-04-20 09:00:00', 33, 22, 6, 11),
(24, 'VOTE-KL-004', '2026-04-20 09:15:00', 34, 21, 6, 12),
-- Ernakulam votes (INC wins 3-1)
(25, 'VOTE-KL-005', '2026-04-20 09:30:00', 37, 26, 7, 13),
(26, 'VOTE-KL-006', '2026-04-20 09:45:00', 38, 26, 7, 13),
(27, 'VOTE-KL-007', '2026-04-20 10:00:00', 39, 25, 7, 13),
(28, 'VOTE-KL-008', '2026-04-20 10:15:00', 40, 26, 7, 14),
-- Kozhikode North votes (CPIM wins 3-1)
(29, 'VOTE-KL-009', '2026-04-20 10:30:00', 43, 29, 8, 15),
(30, 'VOTE-KL-010', '2026-04-20 10:45:00', 44, 29, 8, 15),
(31, 'VOTE-KL-011', '2026-04-20 11:00:00', 45, 30, 8, 15),
(32, 'VOTE-KL-012', '2026-04-20 11:15:00', 46, 29, 8, 16),
-- Thrissur votes (CPIM wins 2-2, tie)
(33, 'VOTE-KL-013', '2026-04-20 11:30:00', 49, 33, 9, 17),
(34, 'VOTE-KL-014', '2026-04-20 11:45:00', 50, 34, 9, 17),
(35, 'VOTE-KL-015', '2026-04-20 12:00:00', 51, 33, 9, 17),
(36, 'VOTE-KL-016', '2026-04-20 12:15:00', 52, 34, 9, 18),
-- Kollam votes (CPIM wins 3-1)
(37, 'VOTE-KL-017', '2026-04-20 12:30:00', 55, 37, 10, 19),
(38, 'VOTE-KL-018', '2026-04-20 12:45:00', 56, 37, 10, 19),
(39, 'VOTE-KL-019', '2026-04-20 13:00:00', 57, 38, 10, 19),
(40, 'VOTE-KL-020', '2026-04-20 13:15:00', 58, 37, 10, 20),
-- Bangalore Central votes (INC wins 3-1)
(41, 'VOTE-KA-001', '2026-03-15 08:30:00', 61, 41, 11, 21),
(42, 'VOTE-KA-002', '2026-03-15 08:45:00', 62, 41, 11, 21),
(43, 'VOTE-KA-003', '2026-03-15 09:00:00', 63, 42, 11, 21),
(44, 'VOTE-KA-004', '2026-03-15 09:15:00', 64, 41, 11, 22),
-- Bangalore South votes (BJP wins 3-1)
(45, 'VOTE-KA-005', '2026-03-15 09:30:00', 67, 46, 12, 23),
(46, 'VOTE-KA-006', '2026-03-15 09:45:00', 68, 46, 12, 23),
(47, 'VOTE-KA-007', '2026-03-15 10:00:00', 69, 45, 12, 23),
(48, 'VOTE-KA-008', '2026-03-15 10:15:00', 70, 46, 12, 24),
-- Mysore votes (INC wins 3-1)
(49, 'VOTE-KA-009', '2026-03-15 10:30:00', 73, 49, 13, 25),
(50, 'VOTE-KA-010', '2026-03-15 10:45:00', 74, 49, 13, 25),
(51, 'VOTE-KA-011', '2026-03-15 11:00:00', 75, 50, 13, 25),
(52, 'VOTE-KA-012', '2026-03-15 11:15:00', 76, 49, 13, 26),
-- Hubli-Dharwad votes (BJP wins 3-1)
(53, 'VOTE-KA-013', '2026-03-15 11:30:00', 79, 54, 14, 27),
(54, 'VOTE-KA-014', '2026-03-15 11:45:00', 80, 54, 14, 27),
(55, 'VOTE-KA-015', '2026-03-15 12:00:00', 81, 53, 14, 27),
(56, 'VOTE-KA-016', '2026-03-15 12:15:00', 82, 54, 14, 28),
-- Mangalore votes (INC wins 3-1)
(57, 'VOTE-KA-017', '2026-03-15 12:30:00', 85, 57, 15, 29),
(58, 'VOTE-KA-018', '2026-03-15 12:45:00', 86, 57, 15, 29),
(59, 'VOTE-KA-019', '2026-03-15 13:00:00', 87, 58, 15, 29),
(60, 'VOTE-KA-020', '2026-03-15 13:15:00', 88, 57, 15, 30),
-- Visakhapatnam East votes (YSRCP wins 3-1)
(61, 'VOTE-AP-001', '2026-06-01 08:30:00', 91, 61, 16, 31),
(62, 'VOTE-AP-002', '2026-06-01 08:45:00', 92, 61, 16, 31),
(63, 'VOTE-AP-003', '2026-06-01 09:00:00', 93, 62, 16, 31),
(64, 'VOTE-AP-004', '2026-06-01 09:15:00', 94, 61, 16, 32),
-- Vijayawada Central votes (YSRCP wins 3-1)
(65, 'VOTE-AP-005', '2026-06-01 09:30:00', 97, 65, 17, 33),
(66, 'VOTE-AP-006', '2026-06-01 09:45:00', 98, 65, 17, 33),
(67, 'VOTE-AP-007', '2026-06-01 10:00:00', 99, 66, 17, 33),
(68, 'VOTE-AP-008', '2026-06-01 10:15:00', 100, 65, 17, 34),
-- Guntur West votes (TDP wins 3-1)
(69, 'VOTE-AP-009', '2026-06-01 10:30:00', 103, 70, 18, 35),
(70, 'VOTE-AP-010', '2026-06-01 10:45:00', 104, 70, 18, 35),
(71, 'VOTE-AP-011', '2026-06-01 11:00:00', 105, 69, 18, 35),
(72, 'VOTE-AP-012', '2026-06-01 11:15:00', 106, 70, 18, 36),
-- Tirupati votes (YSRCP wins 3-1)
(73, 'VOTE-AP-013', '2026-06-01 11:30:00', 109, 73, 19, 37),
(74, 'VOTE-AP-014', '2026-06-01 11:45:00', 110, 73, 19, 37),
(75, 'VOTE-AP-015', '2026-06-01 12:00:00', 111, 74, 19, 37),
(76, 'VOTE-AP-016', '2026-06-01 12:15:00', 112, 73, 19, 38),
-- Rajahmundry votes (TDP wins 3-1)
(77, 'VOTE-AP-017', '2026-06-01 12:30:00', 115, 78, 20, 39),
(78, 'VOTE-AP-018', '2026-06-01 12:45:00', 116, 78, 20, 39),
(79, 'VOTE-AP-019', '2026-06-01 13:00:00', 117, 77, 20, 39),
(80, 'VOTE-AP-020', '2026-06-01 13:15:00', 118, 78, 20, 40),
-- Hyderabad Central votes (TRS wins 3-1)
(81, 'VOTE-TS-001', '2026-02-10 08:30:00', 121, 81, 21, 41),
(82, 'VOTE-TS-002', '2026-02-10 08:45:00', 122, 81, 21, 41),
(83, 'VOTE-TS-003', '2026-02-10 09:00:00', 123, 82, 21, 41),
(84, 'VOTE-TS-004', '2026-02-10 09:15:00', 124, 81, 21, 42),
-- Secunderabad votes (TRS wins 3-1)
(85, 'VOTE-TS-005', '2026-02-10 09:30:00', 127, 85, 22, 43),
(86, 'VOTE-TS-006', '2026-02-10 09:45:00', 128, 85, 22, 43),
(87, 'VOTE-TS-007', '2026-02-10 10:00:00', 129, 86, 22, 43),
(88, 'VOTE-TS-008', '2026-02-10 10:15:00', 130, 85, 22, 44),
-- Warangal East votes (TRS wins 3-1)
(89, 'VOTE-TS-009', '2026-02-10 10:30:00', 133, 89, 23, 45),
(90, 'VOTE-TS-010', '2026-02-10 10:45:00', 134, 89, 23, 45),
(91, 'VOTE-TS-011', '2026-02-10 11:00:00', 135, 90, 23, 45),
(92, 'VOTE-TS-012', '2026-02-10 11:15:00', 136, 89, 23, 46),
-- Karimnagar votes (TRS wins 3-1)
(93, 'VOTE-TS-013', '2026-02-10 11:30:00', 139, 93, 24, 47),
(94, 'VOTE-TS-014', '2026-02-10 11:45:00', 140, 93, 24, 47),
(95, 'VOTE-TS-015', '2026-02-10 12:00:00', 141, 94, 24, 47),
(96, 'VOTE-TS-016', '2026-02-10 12:15:00', 142, 93, 24, 48),
-- Nizamabad votes (TRS wins 3-1)
(97, 'VOTE-TS-017', '2026-02-10 12:30:00', 145, 97, 25, 49),
(98, 'VOTE-TS-018', '2026-02-10 12:45:00', 146, 97, 25, 49),
(99, 'VOTE-TS-019', '2026-02-10 13:00:00', 147, 98, 25, 49),
(100, 'VOTE-TS-020', '2026-02-10 13:15:00', 148, 97, 25, 50)
ON CONFLICT (id) DO NOTHING;

SELECT setval('votes_id_seq', (SELECT COALESCE(MAX(id), 0) + 1 FROM votes), false);
